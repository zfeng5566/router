...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _templateDebug = __webpack_require__(12);
	...
	var _dataManager = __webpack_require__(14);
	...
	exports.default = {
	    ...
	    render: function render(callback) {
	        ...
	        if (data) {
	            var html = _templateDebug2.default.compile(_list2.default)({ list: data });
	            ...
	            $.weui.loading('加载中...');
	            setTimeout(function () {
	                _dataManager2.default.setData('data', _data2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _iswiper = __webpack_require__(17);
	...
	var _swiper3 = __webpack_require__(22);

	var _swiper4 = _interopRequireDefault(_swiper3);

	var _swiper5 = __webpack_require__(23);

	var _swiper6 = _interopRequireDefault(_swiper5);

	var _swiper7 = __webpack_require__(24);
	...
	exports.default = {
	    ...
	    render: function render() {
	        ...
	        var data = _dataManager2.default.getData('data');
	        var article = data.filter(function (article) {
